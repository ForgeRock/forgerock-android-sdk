...
class WebAuthnDataRepositoryTest {
    ...
    fun testPersist(): Unit = runBlocking {
        ...
        assertThat(sources[0].rpid).isEqualTo(source2.rpid)
        assertThat(sources[0].otherUI).isEqualTo(source2.otherUI)
        assertThat(sources[0].userHandle).isEqualTo(source2.userHandle)
        assertThat(sources[0].type).isEqualTo(source2.type)
        assertThat(sources[1].id).isEqualTo(source1.id)
        assertThat(sources[1].rpid).isEqualTo(source1.rpid)
        assertThat(sources[1].otherUI).isEqualTo(source1.otherUI)
        assertThat(sources[1].userHandle).isEqualTo(source1.userHandle)
        assertThat(sources[1].type).isEqualTo(source1.type)
