...
public class FRUser {
    ...
    public static class Browser {
        ...
        public void login(FragmentActivity activity, FRListener<FRUser> listener) {
            ...
            if (!BrowserLauncher.INSTANCE.authorize(this, this.listener)) {
                //fallback to use deprecated AppAuthFragment
                Logger.warn(TAG, "Fallback to use deprecated AppAuthFragment. " +
                        "Please consider to use registerBrowserLauncher() instead.");
                AppAuthFragment.launch(activity.getSupportFragmentManager(), this);
            }
        }
