...
class DefaultStorageClient implements StorageClient {
    ...
    public DefaultStorageClient(Context context) {
        this.accountData = EncryptedPreferences.getInstance(context,
                MigrationKeys.NEW_ORG_FORGEROCK_SHARED_PREFERENCES_DATA_ACCOUNT, ORG_FORGEROCK_SHARED_PREFERENCES_KEYS);
        this.mechanismData =  EncryptedPreferences.getInstance(context,
                MigrationKeys.NEW_ORG_FORGEROCK_SHARED_PREFERENCES_DATA_MECHANISM, ORG_FORGEROCK_SHARED_PREFERENCES_KEYS);
        this.notificationData =  EncryptedPreferences.getInstance(context,
                MigrationKeys.NEW_ORG_FORGEROCK_SHARED_PREFERENCES_DATA_NOTIFICATIONS, ORG_FORGEROCK_SHARED_PREFERENCES_KEYS);
    }
